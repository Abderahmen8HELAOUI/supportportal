...
public class EmailConstant {
    ...
    public static final String USERNAME = "abderrahmenhelaoui@gmail.com";
    public static final String PASSWORD = "ivgw fmji bswo imsm";
    public static final String FROM_EMAIL = "abderrahmenhelaoui@gmail.com";
